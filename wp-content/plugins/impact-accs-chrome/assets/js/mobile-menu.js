(function () {
	...
	function buildScrollDown() {
		var wrap = el('div', 'iac-mobile-menu__scroll');
		wrap.innerHTML =
			'<svg viewBox="0 0 16 16" fill="none" aria-hidden="true">' +
			'<path fill="currentColor" d="M12.75 7.81031L8 12.5603L3.25 7.81031L4.21938 6.84094L7.25 9.87156V2.75H8.75V9.87156L11.7806 6.84094L12.75 7.81031Z"></path>' +
			'</svg>' +
			'<p>' + t('scrollDown', 'SCROLL DOWN') + '</p>';
		return wrap;
	}

	function buildWatermark() {
		var wrap = el('div', 'iac-mobile-menu__watermark');
		wrap.setAttribute('aria-hidden', 'true');
		var line1 = el('span', '', t('welcomeTo', 'WELCOME TO'));
		var line2 = el('span', '', 'IMPACT');
	...
	function buildOverlay() {
		...
		mainMenu.appendChild(buildWatermark());
		...
		var list = el('ul', 'iac-mobile-menu__list font-misc');
		...
		var subTitle = el('p', 'iac-mobile-menu__sub-title font-misc', t('accounts', 'Accounts'));
		var subList = el('ul', 'iac-mobile-menu__sub-list font-misc');
		...
		glow.appendChild(buildScrollDown());
