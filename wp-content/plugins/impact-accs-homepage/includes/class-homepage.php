	...
	public static function render_document() {
		...
		if ( $iac_url && class_exists( 'IAC_Feature_Page' ) ) {
			...
			$head_css  = '<link rel="stylesheet" href="' . $wp_css . '" />'
				...
				. '<style id="iah-hide-investors">html.iah-home section:has([data-credits-badge="true"]),html.iah-home section:has([data-credits-col="0"]){display:none!important;visibility:hidden!important;height:0!important;max-height:0!important;overflow:hidden!important;margin:0!important;padding:0!important;pointer-events:none!important;opacity:0!important}html.iac-lang-ru header button[aria-label="Включить звук"] span.font-misc,html.iac-lang-ru header button[aria-label="Enable sound"] span.font-misc,html.iac-lang-ru header button[aria-label="Unmute sound"] span.font-misc,html.iac-lang-ru header button[aria-label="Выключить звук"] span.font-misc,html.iac-lang-ru header button[aria-label="Mute sound"] span.font-misc{font-size:0!important}html.iac-lang-ru header button[aria-label="Включить звук"] span.font-misc::after,html.iac-lang-ru header button[aria-label="Enable sound"] span.font-misc::after,html.iac-lang-ru header button[aria-label="Unmute sound"] span.font-misc::after{content:"ЗВУК: ВЫКЛ";font-size:.875rem}html.iac-lang-ru header button[aria-label="Выключить звук"] span.font-misc::after,html.iac-lang-ru header button[aria-label="Mute sound"] span.font-misc::after{content:"ЗВУК: ВКЛ";font-size:.875rem}</style>';
