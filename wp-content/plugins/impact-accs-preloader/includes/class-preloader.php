...
class IAP_Preloader {
	...
	public function should_render() {
		// The loading screen is kept only on the homepage (the Next.js mirror
		// renders its own loader there). This plugin only ever ran on inner
		// pages, so disabling it here removes the loader everywhere except home.
		if ( ! apply_filters( 'iap_enable_inner_preloader', false ) ) {
			return false;
		}
