...
define( 'IAH_FAVICON_URL', 'https://cu59725-wordpress-9tad1.tw1.ru/wp-content/uploads/2026/06/cropped-IA.png' );
...
add_action(
	'init',
	static function () {
		if ( get_option( 'iah_rewrite_version' ) !== IAH_VERSION ) {
			iah_register_rewrites();
			flush_rewrite_rules( false );
			update_option( 'iah_rewrite_version', IAH_VERSION );
		}
	},
	99
);
